...
DROP TABLE IF EXISTS POST_LIKED, COMMENT, HASHTAG, POST, FOLLOWER, USER, USER_GROUP, GROUP_MEMBER;
...
SELECT Num INTO @u1 FROM USER WHERE Login='batman';
SELECT Num INTO @u2 FROM USER WHERE Login='catwoman';
SELECT Num INTO @u3 FROM USER WHERE Login='ziggy';
SELECT Num INTO @group FROM USER_GROUP WHERE Name='Superheroes';
...
SELECT Num INTO @u4 FROM USER WHERE Login='lady.z';
SELECT Num INTO @group FROM USER_GROUP WHERE Name='Superheroes';
SELECT @u4, @group;
...
SELECT Num INTO @u4 FROM USER WHERE Login='lady.z';
SELECT Num INTO @group FROM USER_GROUP WHERE Name='Lost Souls';
SELECT @u4, @group;
